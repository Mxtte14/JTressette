...
/**
 * Gestisce il salvataggio e caricamento del profilo utente usando Java Properties.
 * Memorizza i dati in formato chiave-valore semplice, senza librerie esterne.
 * I game record vengono memorizzati come stringhe separate da delimitatori.
 *
 * Percorso file: {user.home}/.jtressette/profile.properties
 *
 * @author andre
 */
public class StorageProfile {
    ...
    /**
     * Carica il profilo utente dal file. Se non esiste, crea un nuovo profilo di default.
     * @return Il profilo utente caricato o creato
     */
